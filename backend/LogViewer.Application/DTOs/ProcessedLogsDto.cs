...
public class ProcessedLogsDto
{
    ...
    [JsonPropertyName("tf_rpc")] public string? TfRpc { get; set; }
    ...
    [JsonPropertyName("tf_resource_type")] public string? TfResourceType { get; set; }
    ...
    [JsonPropertyName("timestamp")] public string? TimestampString { get; set; }
